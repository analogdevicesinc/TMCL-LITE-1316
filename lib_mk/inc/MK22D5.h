 ...
 * @version 1.6
 * @date 2013-06-24
 * @brief Peripheral memory map for MK22D5
 *
 * This header file implements peripheral memory map for MK22D5 processor.
 */
...
#if !defined(MCU_MK22D5)  /* Check if memory map has not been already included */
#define MCU_MK22D5

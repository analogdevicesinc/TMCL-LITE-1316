...
{
  #if defined(MK20DN512) || defined(MK20DX256) || defined(MK20DX128)
  /* Kinetis K20D72 */
  NVICISER2 = (1<<9);    /* Disable interrupts from USB module (Interrupt Clear-Enable Register) */
  ...
  // Kinetis K22
  NVIC->ISER[1] = (1<<21);   /* Disable interrupts from USB module (Interrupt Clear-Enable Register) */
  #else
  #error "USB interrupt not defined"
  #endif
}
...
void USB1_usb_int_en(void)
{
  ...
  #elif defined(MK22FN512)
  // Kinetis K22
  NVIC->ICPR[1] = (1<<21);   /* Clear any pending interrupts on USB (Interrupt Clear-Pending Register) */
  NVIC->ISER[1] = (1<<21);   /* Enable interrupts from USB module (Interrupt Set-Enable Register) */
  #else
  #error "USB interrupt not defined"
  #endif
}
